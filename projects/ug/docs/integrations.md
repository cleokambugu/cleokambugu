...
| **Cephable** | **Hands-free**: the mic button in the nav and in Me listens through the browser's speech engine. Commands: "compare Ntinda to Kampala CBD", "take a seat to Jinja", "my offers", "where is the demand", "night mode", "start the music", "next mix", "help". Replies are spoken back. | Cephable's face, head and switch controls for people who cannot use a touchscreen, and automations that act on rules ("take my Friday seat when it opens"). |
