...
| **v1** | `site/index.html` (current) | The app shell and the Virtual Stage: two doors, the sixty-second Handshake, paid intents that fill a stage, a driver's Comfort Map and funded-offer feed, empty legs, Me, a bottom tab bar, a manifest, and the panel's quick wins folded in. Twenty-three towns on the map, local apps recognised per town. |
